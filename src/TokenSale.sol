...
contract TokenSale is Initializable, Ownable2Step, ReentrancyGuard, Account {
     ...
     */
    constructor(IERC20 _saleToken, uint256 _cap, uint256 _price) {
    ...
    function init() external initializer {
        ...
        require(
            cap.eq(ud(IERC20(saleToken).balanceOf(address(this)))),
     ...
     *
     */
    function withdrawERC20(address token, address to, uint256 amount) external virtual override onlyOwner {
     ...
     *
     */
    function calculatePurchaseAmountOut(UD60x18 ethAmountIn) public view returns (UD60x18 tokenAmountOut) {
