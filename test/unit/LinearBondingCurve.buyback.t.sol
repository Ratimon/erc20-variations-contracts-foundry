...
contract TestUnitLinearBondingCurve_buyback is Test, RegisterScripts, ConstantsFixture, DeploymentERC1363WithSanction, DeploymentLinearBondingCurve {
    ...
    function setUp() public virtual {
        vm.label(address(this), "TestUnitLinearBondingCurve_buyback");
