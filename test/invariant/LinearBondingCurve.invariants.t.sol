...
contract LinearBondingCurveInvariants is
    StdInvariant,
    Test,
    ConstantsFixture,
    DeploymentERC1363WithSanction,
    DeploymentLinearBondingCurve
{
    ...
    function invariant_Poolbalance_eq_saleTokenBalance() public {
        ...
        assertEq(
            unwrap(LinearCurve(address(linearBondingCurve)).getPoolBalance(buyTokenSupply)),
